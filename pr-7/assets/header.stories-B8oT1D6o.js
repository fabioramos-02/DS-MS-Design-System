import{C as a}from"./codePreview-Db2E5PIM.js";/* empty css               */const E=""+new URL("brasao-governo-DMGz5kNl.png",import.meta.url).href;function T(){document.querySelectorAll(".ds-header").forEach(o=>{const i=o.querySelector(".ds-header__menu-button"),S=o.querySelector(".ds-header__navigation");!i||!S||i.addEventListener("click",()=>{const D=i.getAttribute("aria-expanded")==="true";i.setAttribute("aria-expanded",String(!D)),S.classList.toggle("is-open",!D)})})}const w={title:"Componentes/Header"},r=["src/styles/variables.css","src/styles/typography.css","src/styles/spacing.css","src/styles/radius.css","src/components/search/search.css","src/components/header/header.css"],s=["src/components/header/header.js"],m=`
<span class="ds-header__logo">
    <img src="${E}" alt="Governo do Estado de Mato Grosso do Sul">
</span>

<span class="ds-header__divider" aria-hidden="true"></span>
`,e={id:"ds-header",status:"Em validação",version:"1.0.0",category:"Components",updated:"2026-06-29"},n=["O Header depende dos tokens globais do Design System MS.","A classe base obrigatória é <code>ds-header</code>.","Use <code>ds-header--governo</code>, <code>ds-header--secretaria</code> ou <code>ds-header--subsecretaria</code> apenas para identificar o tipo institucional.","A cor da barra principal permanece sempre <code>--ds-color-primary-600</code>.","Durante o período eleitoral, o Header não deve exibir links de redes sociais.","O JavaScript é necessário apenas para abrir e fechar o menu no mobile.","A busca reutiliza o componente <code>Search</code> com as classes <code>ds-search</code>, <code>ds-search__input</code> e <code>ds-search__button</code>."],L=["Identificar o site institucional do Governo, secretaria, órgão ou subsecretaria.","Exibir links principais de navegação.","Disponibilizar acesso à busca do site.","Organizar links de acessibilidade, transparência e ouvidoria."],y=["Dentro do conteúdo principal da página.","Como título interno de seções, nesse caso utilize Page Header ou Section Title.","Para menus laterais ou navegação contextual."],k=["<code>ds-header--governo</code> — estrutura textual para páginas do Governo do Estado.","<code>ds-header--secretaria</code> — estrutura textual para secretarias e órgãos.","<code>ds-header--subsecretaria</code> — estrutura textual para subsecretarias ou estruturas vinculadas."],f=`
...
`;function v(H){return H.map(o=>`<li>${o}</li>`).join("")}function d(){setTimeout(()=>{T()},0)}function G(){return`
...
`,t={name:"Documentação",render:()=>G()},c={name:"All",render:()=>(d(),a({title:"Header - HTML",description:"Exemplo de HTML para replicar todas as variações principais do componente Header.",meta:e,preview:x,code:x,language:"markup",cssDependencies:r,jsDependencies:s,notes:n}))},l={name:"Governo",render:()=>(d(),a({title:"Header Governo - HTML",description:"Exemplo de Header para páginas do Governo do Estado.",meta:e,preview:_,code:_,language:"markup",cssDependencies:r,jsDependencies:s,notes:n}))},p={name:"Secretaria",render:()=>(d(),a({title:"Header Secretaria - HTML",description:"Exemplo de Header para secretarias e órgãos.",meta:e,preview:b,code:b,language:"markup",cssDependencies:r,jsDependencies:s,notes:n}))},u={name:"Subsecretaria",render:()=>(d(),a({title:"Header Subsecretaria - HTML",description:"Exemplo de Header para subsecretarias ou estruturas vinculadas.",meta:e,preview:g,code:g,language:"markup",cssDependencies:r,jsDependencies:s,notes:n}))},h={name:"Sem Busca",render:()=>(d(),a({title:"Header sem Busca - HTML",description:"Exemplo de Header sem formulário de busca.",meta:e,preview:M,code:M,language:"markup",cssDependencies:r,jsDependencies:s,notes:n}))};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  name: 'Documentação',
...
}`,...h.parameters?.docs?.source}}};const A=["Documentacao","HTMLHeaders","HTMLGoverno","HTMLSecretaria","HTMLSubsecretaria","HTMLSemBusca"];export{t as Documentacao,l as HTMLGoverno,c as HTMLHeaders,p as HTMLSecretaria,h as HTMLSemBusca,u as HTMLSubsecretaria,A as __namedExportsOrder,w as default};
