const r={title:"Tokens/Radius"},i=[["None","--ds-radius-none","0"],["2XSM","--ds-radius-2xsm","1px"],["1XSM","--ds-radius-1xsm","2px"],["XSM","--ds-radius-xsm","4px"],["SM","--ds-radius-sm","8px"],["MD","--ds-radius-md","12px"],["LG","--ds-radius-lg","16px"],["XLG","--ds-radius-xlg","20px"],["BIG","--ds-radius-big","32px"],["HUGE","--ds-radius-huge","9999px"]];function n([a,s,d]){return`
        <article style="
            display: grid;
  ...
  render: () => \`
    ...
    \`
}`,...e.parameters?.docs?.source}}};const o=["Radius"];export{e as Radius,o as __namedExportsOrder,r as default};
